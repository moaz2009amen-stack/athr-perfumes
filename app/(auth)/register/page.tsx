    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-background via-background to-gold/5">
      ...
      <Card className="w-full max-w-md border-gold/20 bg-card/95 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription>أدخل بياناتك للانضمام إلى عائلة أثر</CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn('pr-10', errors.full_name && 'border-destructive')}
                  {...register('full_name')}
                  disabled={isLoading}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className={cn('pr-10 pl-10', errors.confirm_password && 'border-destructive')}
